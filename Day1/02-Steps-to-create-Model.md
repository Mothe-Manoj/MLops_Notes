...
4. Train - Model will train bye the pattern identification
5. Test - Tesing the model
6. Retraining - If needed
7. Save - Packaging the model
8. Using the model - developing APIs, etc..
